  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-14 md:py-20">
      ...
      <p className="mt-3 max-w-2xl text-sm text-muted-foreground">
        Questions about an order, sizing, availability or a wholesale enquiry? Our team replies
      ...
      <div className="mt-12 grid gap-10 md:grid-cols-2">
        <div className="space-y-5 text-sm">
          <ContactRow
            icon={Mail}
            title="Email"
            value="support@miravika.com"
            href="mailto:support@miravika.com"
          />
          <ContactRow
            icon={MessageCircle}
            title="WhatsApp"
            value="Fastest replies — chat with us on WhatsApp"
            href="https://wa.me/"
          />
          <ContactRow
            icon={Instagram}
            title="Instagram"
            value="@miravika.india"
        ...
        <form
          onSubmit={onSubmit}
          className="space-y-3 rounded-md border border-border/60 bg-card p-6"
        >
          <input
            value={form.name}
