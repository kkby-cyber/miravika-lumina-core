...
export const Route = createFileRoute("/cart")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Review the items in your MIRAVIKA shopping bag and proceed to secure checkout.",
      },
          ...
          <div className="space-y-4">
            {items.map((it) => {
              ...
              return (
                <div
                  key={it.variantId}
                  className="flex gap-4 rounded-md border border-border/60 bg-card p-4"
                >
