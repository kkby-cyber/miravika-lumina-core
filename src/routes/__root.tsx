...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Luxury hair accessories handcrafted in India." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "MIRAVIKA" },
      { name: "twitter:description", content: "Luxury hair accessories handcrafted in India." },
    ],
    links: [
